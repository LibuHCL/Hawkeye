...
public class DashBoardProjectslist {
	 ...
	 private List<DashBoardResource> resource;
	...
	public List<DashBoardResource> getResource() {
		return resource;
	}


	public void setResource(List<DashBoardResource> resource) {
