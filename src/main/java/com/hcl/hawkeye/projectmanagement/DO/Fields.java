...
public class Fields implements Serializable {
	...
	/**
	 * @param customfield_10002
	 *            the customfield_10002 to set
	 */
	...
	public int hashCode() {
		...
		result = prime * result + ((customfield_10002 == null) ? 0 : customfield_10002.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (created == null) {
			...
			return false;
		if (customfield_10002 == null) {
			if (other.customfield_10002 != null)
				return false;
		} else if (!customfield_10002.equals(other.customfield_10002))
			return false;
		if (issuetype == null) {
	...
	public String toString() {
		return "Fields [issuetype=" + issuetype + ", priority=" + priority + ", resolutiondate=" + resolutiondate
				+ ", created=" + created + ", status=" + status + ", customfield_10002=" + customfield_10002 + "]";
	}
}
